...
fun String.isValidEmail(): Boolean {
    return if (this.isEmpty()) {
        ...
        Regex(emailPattern).matches(this)
    }
}
...
fun String.containsHtml(): Boolean {
    val htmlPattern = "<[^>]*>"
    return Regex(htmlPattern).containsMatchIn(this)
}
...
object InputValidator {
    ...
    fun validateNoteValue(value: Double): ValidationResult {
        ...
        return ValidationResult.Success(formatTwoDecimals(value))
    }
    ...
    private fun logInvalidAttempt(
        ...
        val ignored = "INVALID INPUT [$method]: '$sanitized...' - Reason: $reason"
    }
    ...
    fun logValidInput(method: String, input: String) {
        ...
        @Suppress("UNUSED_VARIABLE")
        val ignored = "VALID INPUT [$method]: '$sanitized...'"
    }

    private fun formatTwoDecimals(value: Double): String {
        val cents = (value * 100.0).roundToInt()
        val whole = cents / 100
        val decimal = kotlin.math.abs(cents % 100).toString().padStart(2, '0')
